...
export const cases = [
  ...
  {
    slug: "werktijden",
    client: "Werktijden.nl",
    industry: "SaaS · Workforce management",
    service: "Process + Build + Adopt",
    headline: "From scattered commercial process to a CRM the team actually uses",
    summary:
      "Werktijden.nl had 6,500+ customers and a growing sales operation — but no clear picture of how commercial activity flowed. We mapped the full customer journey, rebuilt it in HubSpot, and made sure the team actually adopted it.",
    result: "Full customer journey mapped and implemented, backend integration live, team trained and using the system daily.",
    quote: "Levi's combination of strategic vision and practical execution makes him a strong addition to any team.",
    gradient: "linear-gradient(135deg, #0f0a02 0%, #1a100a 100%)",
    accent: "#fb923c",
